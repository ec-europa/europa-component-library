          ...
          <div class="ecl-col-sm ecl-footer__column">
            ...
            <ul class="ecl-list ecl-list--unstyled ecl-list--inline ecl-footer__list ecl-footer__list--inline ecl-footer__social-links ecl-u-d-inline">
              <li class="ecl-footer__list-item">
                <a
                  class="ecl-link ecl-footer__link ecl-link--external"
                  href="https://github.com/ec-europa/europa-component-library"
                >
                  GitHub
                </a>
              </li>
    ...
    <div class="ecl-footer__corporate">
      <div class="ecl-footer__corporate-top">
        <div class="ecl-container">
          <div class="ecl-row">
            <div class="ecl-col-sm ecl-footer__column">
              <h4 class="ecl-h4 ecl-footer__column-title">
                European Commission
              </h4>
              <ul class="ecl-list ecl-list--unstyled ecl-footer__list">
                <li class="ecl-footer__list-item">
                  <a
                    class="ecl-link ecl-link--inverted ecl-footer__link"
              ...
              <ul class="ecl-list ecl-list--unstyled ecl-list--inline ecl-footer__list ecl-footer__list--inline  ecl-footer__social-links">
                <li class="ecl-footer__list-item">
                  <a
                    ...
                    href="#"
                  >
                    <span class="ecl-icon ecl-icon--facebook ecl-footer__social-icon" />Facebook
                  </a>
                </li>
                <li class="ecl-footer__list-item">
                  <a
                    ...
                    href="#"
                  >
                    <span class="ecl-icon ecl-icon--twitter ecl-footer__social-icon" />Twitter
                  </a>
                </li>
                <li class="ecl-footer__list-item">
                  <a
                    class="ecl-link ecl-link--inverted ecl-link--external ecl-footer__link"
                    href="#"
                  >
                    Other social media
                  </a>
