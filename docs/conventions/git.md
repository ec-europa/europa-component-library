...
*This documented was extracted from [Contributing to AngularJS](https://github.com/angular/angular.js/blob/master/CONTRIBUTING.md). Every contributor to the project should be aware of the following rules.*
