...
| [ecl-static-page.md](./ecl-static-page.md)           | Composing a standalone static HTML page/prototype from ECL components — split by page type (`ecl-static-page-{homepage,inner}.md`), read only the one that applies |
