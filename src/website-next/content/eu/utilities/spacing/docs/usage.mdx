...
Different clases can be used to set the margin around an element. All spacing values are listed on <Link to="/eu/guidelines/spacing/">guidelines</Link>.
...
- `ecl-u-mr-*` (ecl-u-mr-2xs to ecl-u-mr-4xl): right/end margins
- `ecl-u-mb-*` (ecl-u-mb-2xs to ecl-u-mb-4xl): bottom margins
- `ecl-u-ml-*` (ecl-u-ml-2xs to ecl-u-ml-4xl): left/start margins
...
Different clases can be used to set the padding inside an element. All spacing values are listed on <Link to="/eu/guidelines/spacing/">guidelines</Link>.
...
- `ecl-u-pr-*` (ecl-u-pr-2xs to ecl-u-pr-4xl): right/end padding
- `ecl-u-pb-*` (ecl-u-pb-2xs to ecl-u-pb-4xl): bottom padding
- `ecl-u-pl-*` (ecl-u-pl-2xs to ecl-u-pl-4xl): left/start padding
