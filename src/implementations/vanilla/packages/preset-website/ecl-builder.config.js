...
module.exports = {
  scripts: [
    {
      entry: path.resolve(__dirname, 'src/preset-website.js'),
      dest: path.resolve(outputFolder, 'scripts/ecl-preset-website.js'),
      options: {
        banner,
        moduleName: 'ECL',
  ...
  styles: [
    {
      entry: path.resolve(__dirname, 'src/preset-website.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-preset-website.css'),
      options: {
        banner,
        includePaths,
    ...
    {
      entry: path.resolve(__dirname, 'src/preset-website-print.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-preset-website-print.css'),
      options: {
        banner,
        includePaths,
        sourceMap: isProd ? 'file' : true,
