...
module.exports = {
  scripts: [
    {
      entry: path.resolve(__dirname, 'src/ecl-preset-ec-core.js'),
      dest: path.resolve(outputFolder, 'scripts/ecl-preset-ec-core.js'),
      options: {
        banner,
        moduleName: 'ECL',
  ...
  styles: [
    {
      entry: path.resolve(__dirname, 'src/ecl-preset-ec-core.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-preset-ec-core.css'),
      options: {
        banner,
        includePaths,
    ...
    {
      entry: path.resolve(__dirname, 'src/ecl-preset-ec-core-print.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-preset-ec-core-print.css'),
      options: {
        banner,
        includePaths,
        sourceMap: isProd ? 'file' : true,
