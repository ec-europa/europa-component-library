...
module.exports = {
  scripts: [
    {
      entry: path.resolve(__dirname, 'src/preset-full.js'),
      dest: path.resolve(outputFolder, 'scripts/ecl-preset-full.js'),
      options: {
        banner,
        moduleName: 'ECL',
  ...
  styles: [
    {
      entry: path.resolve(__dirname, 'src/preset-full.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-preset-full.css'),
      options: {
        banner,
        includePaths,
    ...
    {
      entry: path.resolve(__dirname, 'src/preset-full-print.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-preset-full-print.css'),
      options: {
        banner,
        includePaths,
        sourceMap: isProd ? 'file' : true,
