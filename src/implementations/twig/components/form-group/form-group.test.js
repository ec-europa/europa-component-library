...
describe('Form group ', () => {
  ...
  describe('with Text field', () => {
    ...
    test(`passes the accessibility tests`, async () => {
      expect(
        await axe(renderTwigFileAsHtml(template, dataText, true))
      ).toHaveNoViolations();
    });
  });
  ...
  describe('with Rating field', () => {
    ...
    test(`passes the accessibility tests`, async () => {
      expect(
        await axe(renderTwigFileAsHtml(template, dataRatingField, true))
      ).toHaveNoViolations();
    });
  });
  ...
  describe('with Range field', () => {
    ...
    test(`passes the accessibility tests`, async () => {
      expect(
        await axe(renderTwigFileAsHtml(template, dataRange, true))
      ).toHaveNoViolations();
    });
  });
  ...
  describe('with Textarea', () => {
    ...
    test(`passes the accessibility tests`, async () => {
      expect(
        await axe(renderTwigFileAsHtml(template, dataTextarea, true))
      ).toHaveNoViolations();
    });
  });
  ...
  describe('with Checkbox', () => {
    ...
    test(`passes the accessibility tests`, async () => {
      expect(
        await axe(renderTwigFileAsHtml(template, dataCheckbox, true))
      ).toHaveNoViolations();
    });
  });
  ...
  describe('with Datepicker', () => {
    ...
    test(`passes the accessibility tests`, async () => {
      expect(
        await axe(renderTwigFileAsHtml(template, dataDatepicker, true))
      ).toHaveNoViolations();
    });
  });
});
