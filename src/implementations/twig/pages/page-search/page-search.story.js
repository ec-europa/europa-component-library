...
import dataSearch from '@ecl/specs-page-search/demo/data';
import search from './page-search.html.twig';
...
Default.render = async () => {
  const renderedSearch = await search(prepareData(dataSearch));
