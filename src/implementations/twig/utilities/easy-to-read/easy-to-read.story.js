          ...
          <article dir="ltr">
            <div>
              ...
              <div class="ecl">
                ...
                <div class="ecl-media-container" data-ecl-media-container="true" data-ecl-auto-init="MediaContainer">
                  <figure class="ecl-media-container__figure">
                    <div class="ecl-media-container__media"><img loading="eager" class="ecl-u-max-width-100 ecl-u-height-auto" src="https://www.inclusion-europe.eu/wp-content/uploads/2019/03/Easy-to-read-logo-150x150.jpg"></div>
                  </figure>
                </div>
                <p>
              ...
              <div class="ecl">
                ...
                <div class="ecl-media-container" data-ecl-media-container="true" data-ecl-auto-init="MediaContainer">
                  <figure class="ecl-media-container__figure">
                    <div class="ecl-media-container__media"><img loading="eager" class="ecl-u-max-width-100 ecl-u-height-auto" srcset="https://european-union.europa.eu/sites/default/files/styles/embed_large/public/2024-05/european-map_en.jpg?itok=LOOq8mBS" alt="Map with all countries of the European Union"></div>
                  </figure>
                </div>
              </div>
              <h2>How the European Union started</h2>
                ...
                <div class="ecl-featured-item__container ecl-featured-item__container--right">
                  <div class="ecl-featured-item__item">
                    <div class="ecl-featured-item__description">
                      <div class="ecl">
                        <p>The idea to make the European Union came<br>
                          after two big wars happened in Europe.<br>
                          Countries in Europe saw that<br>
                          it is better to work together<br>
              ...
              <h2>The goals and values of the European Union</h2>
              <div class="ecl">
                    ...
                    <div class="ecl-featured-item__description">
                      <div class="ecl">
                        <ul>
                          ...
                          <li>the languages and cultures of all people<br>
                            are respected
                          </li>
                          <li>there is a strong European economy<br>
                            and countries use the same coin<br>
              ...
              <article class="ecl-featured-item">
                <div class="ecl-featured-item__container ecl-featured-item__container--right">
                  <div class="ecl-featured-item__item">
                    <div class="ecl-featured-item__description">
                      <div class="ecl">
                        <p>After the European Union was created,<br>
                          there were no more wars between the countries<br>
                          that are part of the European Union.<br>
                          Thanks to the European Union,<br>
              ...
              <article class="ecl-featured-item">
                <div class="ecl-featured-item__container ecl-featured-item__container--right">
                  <div class="ecl-featured-item__item">
                    <div class="ecl-featured-item__description">
                      <div class="ecl">
                        <p>In 2012, the European Union won a big award<br>
                          which is called ‘<strong>the Nobel Peace Prize</strong>’.<br>
                          This award was given to the European Union<br>
              ...
              <h2>The European Union in the world</h2>
              <div class="ecl">
              ...
              <h2>Becoming part of the European Union</h2>
              <div class="ecl">
              ...
              <div class="ecl">
                ...
                <div class="ecl-media-container  ecl-u-mb-s ewcms-embed-medium" data-ecl-media-container="true" data-ecl-auto-init="MediaContainer" >
                  <figure class="ecl-media-container__figure">
                    <div class="ecl-media-container__media"><img loading="eager" class="ecl-u-max-width-100 ecl-u-height-auto" srcset="https://european-union.europa.eu/sites/default/files/styles/embed_medium/public/2021-10/happy-travelers_en.jpg?itok=Yzcgs5PM 1x, /sites/default/files/styles/embed_medium_2x/public/2021-10/happy-travelers_en.jpg?itok=LJ0Z2MXM 2x" width="429" height="306" src="/sites/default/files/styles/embed_medium/public/2021-10/happy-travelers_en.jpg?itok=Yzcgs5PM" alt="Happy travelers"></div>
                  </figure>
                </div>
              </div>
                <h2>Languages of the European Union</h2>
                <div class="ecl">
                ...
                <h2>The coin of the European Union</h2>
                <div class="ecl">
                ...
                <article class="ecl-featured-item">
                  <div class="ecl-featured-item__container ecl-featured-item__container--right">
                    <div class="ecl-featured-item__item">
                      <div class="ecl-featured-item__description">
                        <div class="ecl">
                          <p>This coin is called ‘<strong>Euro</strong>’.<br>
                            Using the same coin helps countries<br>
                            in the European Union to do business together.<br>
                            For example, people from Spain<br>
                            can buy things they want from Belgium<br>
                            easily and without extra costs.<br>
                            Using the same coin<br>
                            makes it easier for people to travel,<br>
                            buy things online from other countries<br>
                ...
                <article class="ecl-featured-item">
                  <div class="ecl-featured-item__container ecl-featured-item__container--right">
                    <div class="ecl-featured-item__item">
                      <div class="ecl-featured-item__description">
                        <div class="ecl">
                          <p>The melody shows how important it is<br>
                            that all people are free, live in peace<br>
                            and stand by each other.<br>
                            The European Union believes in these values<br>
                            and that is why it has chosen this melody<br>
                            to be its anthem.
                          </p>
                          <p>
                ...
                <div class="ecl-featured-item__container ecl-featured-item__container--right">
                  <div class="ecl-featured-item__item">
                    <div class="ecl-featured-item__description">
                      <div class="ecl">
                        <ul>
                          <li>people in the European Union<br>
                            may have different cultures or languages<br>
                            but they stand by each other<br>
                            and work together in peace.
                          </li>
                          <li>there is nothing wrong<br>
                            about having different languages or cultures.<br>
                            On the contrary.<br>
                            People with different cultures<br>
              ...
              <h2>How the European Union works</h2>
              <div class="ecl">
                ...
                <div class="ecl-featured-item__container ecl-featured-item__container--right">
                  <div class="ecl-featured-item__item">
                    <div class="ecl-featured-item__description">
                      <div class="ecl">
                        <ul>
                          <li>the&nbsp;<strong>European Commission</strong><br>
                            The people of the European Commission<br>
                      ...
                      <div class="ecl">
                        <ul>
                          <li>the&nbsp;<strong>European Parliament</strong><br>
                            The people of the European Parliament<br>
                            are elected by all people in Europe<br>
                ...
                <div class="ecl-featured-item__container ecl-featured-item__container--right">
                  <div class="ecl-featured-item__item">
                    <div class="ecl-featured-item__description">
                      <div class="ecl">
                        <ul>
                          <li>the&nbsp;<strong>Council of the European Union</strong><br>
                            People who make decisions<br>
                            in every country of the European Union<br>
                            come together and make<br>
                ...
                <div class="ecl-featured-item__container ecl-featured-item__container--right">
                  <div class="ecl-featured-item__item">
                    <div class="ecl-featured-item__description">
                      <div class="ecl">
                        <ul>
                          <li>check if the European Union works in the right<br>
                            way and respects the rights of all people.
                          </li>
                          <li>publish useful information<br>
                            about the European Union.
                          </li>
                          <li>choose the people who have the skills<br>
                            to work for the European Union.
                          </li>
                          <li>stand for the rights of all people in Europe<br>
                            like people with disabilities, workers and others.
                          </li>
                        </ul>
                        <p>All these bodies work together to make sure that the European Union works<br>
