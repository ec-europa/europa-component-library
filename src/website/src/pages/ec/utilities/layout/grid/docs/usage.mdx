...
import example234612 from '@ecl/grid/examples/234612.html';
import example642 from '@ecl/grid/examples/642.html';
import example282 from '@ecl/grid/examples/282.html';
import example336 from '@ecl/grid/examples/336.html';
import offset from '@ecl/grid/examples/offset.html';
