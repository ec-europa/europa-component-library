...
<Playground hideCode>
  <div className="ecl-u-ph-m ecl-u-pv-xl">
    <div className="ecl-u-type-l ecl-u-type-bold">Heading 4 mobile</div>
    <div className="ecl-u-type-xl ecl-u-type-bold ecl-u-mt-m">Heading 4 desktop</div>
  </div>
</Playground>
...
<Playground hideCode>
  <div className="ecl-u-ph-m ecl-u-pv-xl">
    <div className="ecl-u-type-m ecl-u-type-bold">Heading 5 mobile/desktop</div>
  </div>
</Playground>
