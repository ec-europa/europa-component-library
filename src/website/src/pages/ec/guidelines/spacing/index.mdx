...
| Name | Size |
| ---- | -------------------------------------- |
| 13xl | <RemToPixels rem="4.5" />px - 4.5rem |
| 12xl | <RemToPixels rem="4.25" />px - 4.25rem |
| 11xl | <RemToPixels rem="4" />px - 4rem |
| 10xl | <RemToPixels rem="3.75" />px - 3.75rem |
| 9xl | <RemToPixels rem="3.5" />px - 3.5rem |
| 8xl | <RemToPixels rem="3.25" />px - 3.25rem |
| 7xl | <RemToPixels rem="3" />px - 3rem |
| 6xl | <RemToPixels rem="2.75" />px - 2.75rem |
| 5xl | <RemToPixels rem="2.5" />px - 2.5rem |
| 4xl | <RemToPixels rem="2.25" />px - 2.25rem |
| 3xl | <RemToPixels rem="2" />px - 2rem |
| 2xl | <RemToPixels rem="1.75" />px - 1.75rem |
...
| 2xs | <RemToPixels rem="0.375" />px - 0.375rem |
| 3xs | <RemToPixels rem="0.25" />px - 0.25rem |
| 4xs | <RemToPixels rem="0.125" />px - 0.125rem |
| 5xs | <RemToPixels rem="0.0625" />px - 0.0625rem |
