...
| Name | Size |
| ---- | -------------------------------------- |
| 10xl | <RemToPixels rem="5" />px - 5rem |
| 9xl | <RemToPixels rem="4.5" />px - 4.5rem |
| 8xl | <RemToPixels rem="4" />px - 4rem |
| 7xl | <RemToPixels rem="3.5" />px - 3.5rem |
| 6xl | <RemToPixels rem="3" />px - 3rem |
