...
- ensure the pages contain all the elements in the Anatomy table above, however check [Europa Web Guide - Standardised sites](https://wikis.ec.europa.eu/display/WEBGUIDE/02.+EC+branded+standardised+websites+design) for a detailed instructions on the optional elements and exceptions
