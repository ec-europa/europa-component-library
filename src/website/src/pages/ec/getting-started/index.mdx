...
- `ecl-ec-color-modes.css`: contains css definition for the color modes. See the <Link to="/ec/guidelines/colours/" label="Colours documentation" /> for more information
