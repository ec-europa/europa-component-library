...
<ul>
  <li>
    <a
      className="ecl-link"
      href={`https://cdn1.fpfis.tech.ec.europa.eu/ecl/v${ECL_VERSION}/eu/styles/ecl-ec.css`}
    >
      {`https://cdn1.fpfis.tech.ec.europa.eu/ecl/v${ECL_VERSION}/eu/styles/ecl-ec.css`}
    </a>
  </li>
  <li>
    <a
