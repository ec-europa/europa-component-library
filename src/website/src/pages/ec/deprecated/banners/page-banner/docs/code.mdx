...
<Playground
  system="ec"
  selectedKind="deprecated-banners-page-banner"
  selectedStory="image"
>
...
However, if there is a need to have a full width banner inside the grid container, the css class `.ecl-page-banner--fullwidth` can be used (just put it at the same level as `.ecl-page-banner`).
