...
<Paragraph size="lead">
  <strong>The Harmonised page header (Group 1 and Group 2)</strong> gives
  context and confidence to the user so they understand what the page is about,
  to be placed just below the Site header.
</Paragraph>
