...
<Paragraph size="lead">
  <strong>The Harmonised group 1 page header</strong> page header gives context
  and confidence to the user so they understand what the page is about, to be
  placed just below the Site header.
</Paragraph>
