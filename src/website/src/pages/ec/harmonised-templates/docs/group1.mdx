...
<Paragraph size="lead">
  On this page you will find information related to the EC branded{' '}
  <strong>Harmonised group 1 websites</strong> that host specific content that
  answers a particular communication purpose, in particular:
</Paragraph>
