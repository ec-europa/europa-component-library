...
<Paragraph size="lead">
  ...
  purpose, in particular web information systems. These are represented by
  permanent websites that provide a user-friendly interface to generate,
  disclose and/or filter large, detailed amounts of data stored across different
  systems.
</Paragraph>
...
- do not follow these guidelines when you are updating sites that fall under internal policy websites - use <Link to="/ec/harmonised-templates/group3/">Harmonised Group 3</Link> instead
