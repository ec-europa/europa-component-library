...
| Europa search form       | Contextual&nbsp;\* | Enables the user to search and retrieve related information from the database using keywords<br />\* use a Search form component if the content of the campaign page would lead users to search for other information at a Europa level |
