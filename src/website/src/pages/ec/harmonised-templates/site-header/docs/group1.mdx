...
| login                                                                                   | contextual&nbsp;\* | login component for ECAS account<br />\* use a Login component if your website has a user database                                                                                                                                |
...
| <Link to="/ec/components/forms/search-form/usage/" standalone>Europa search form</Link> | contextual&nbsp;\* | enables the user to search and retrieve related information from the database using keywords                                                                                                                                      |
| class name                                                                              | contextual&nbsp;\* | banner indicating the parent class under which the site falls<br />\* use a Class name component if the website you are creating or updating falls under one of the classes on the <Link to="/ec/core-template/">Core site</Link> |
