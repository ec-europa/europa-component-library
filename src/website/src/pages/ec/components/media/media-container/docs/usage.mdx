...
| ---------------- | --------------- |
| <Anatomy image="https://inno-ecl.s3.amazonaws.com/media/images/EC/Media%20Container/Media%20container.png" alt="Anatomy of media container desktop" legend={{ items: [ { color: '#404040', label: 'mandatory', }, { color: '#004494', label: 'optional', },     ],   }} /> | <Anatomy   image="https://inno-ecl.s3.amazonaws.com/media/images/EC/Media%20Container/Media%20container%20-%20Mobile.png"   alt="Anatomy of media container mobile"   legend={{     items: [ { color: '#404040', label: 'mandatory', }, { color: '#004494', label: 'optional', },     ],   }} /> |
