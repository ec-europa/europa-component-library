...
| 3   | action indicator       | yes       | varies depending on the state (collapsed/expanded). Indicates wether sub-items are present and what next action will do - expands/collapses content container on hover |
...
| 2   | close button                        | yes       | hover state of items                                                                                                                                                              |
| 3   | active selection                    | yes       | current page selection                                                                                                                                                            |
| 4   | action indicator                    | yes       | varies depending on the state. Indicates wether sub-items are present and what next action will do                                                                                |
