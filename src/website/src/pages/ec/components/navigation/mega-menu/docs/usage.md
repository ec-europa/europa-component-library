...
- do not use for simple websites with only one or two levels of navigation — opt for a [Horizontal menu component](https://ec.europa.eu/component-library/eu/components/navigation/menu/code/) instead
