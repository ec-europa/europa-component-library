...
- Labels - should be clear and distinct. Try using verbs to describe the action that the user will perform when interacting with the button. Keep it short, no more than 3 words and only capitalise the first word. 
- Colour - choose a colour that provides sufficient contrast between the label and background. 
- Icon - choose an icon that can reinforce or clarify the meaning of a label in that particular context.   
