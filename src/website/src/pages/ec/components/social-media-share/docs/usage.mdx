...
| Link                 | no        | When more than 4-6 social networks are used, the button will open a pop-up where more social networks can be found |
...
- <Link to="/ec/components/social-media-follow/usage/">
    Social media follow
  </Link>
