...
<Paragraph size="lead">
  ...
  applying for funding. They have an aspect-ratio of 4:1.
</Paragraph>
...
**<Link to="/ec/components/banners/page-banner/code/">See all variants in showcase</Link>**
...
| text box / gradient overlay / shaded overlay | yes       | element that allows for better font-to-background contrast ratio<br /><br />**Note**: If the gradient or shaded overlay option has been selected, the text will then be displayed directly on top of the image and not within the text box (see anatomy images) |
