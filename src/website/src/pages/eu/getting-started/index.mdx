...
{' '}
<a
  href={`https://cdn1.fpfis.tech.ec.europa.eu/ecl/${ECL_VERSION}/eu/styles/optional/ecl-ec-default.css`}
>
  {`https://cdn1.fpfis.tech.ec.europa.eu/ecl/${ECL_VERSION}/eu/styles/optional/ecl-ec-default.css`}
</a>
)
