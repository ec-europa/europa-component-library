...
<ul>
  ...
  <li>
    <a
      className="ecl-link"
      href={`https://cdn1.fpfis.tech.ec.europa.eu/ecl/v${ECL_VERSION}/ec/scripts/ecl-esm-eu.js`}
    >
      {`https://cdn1.fpfis.tech.ec.europa.eu/ecl/v${ECL_VERSION}/ec/scripts/ecl-esm-eu.js`}
    </a>
  </li>
</ul>
...
All the elements containing a `data-ecl-tooltip` or a `data-ecl-tooltip-inverted` inverted will have their tooltip associated, it will grab its content from the data attribute
...
Template are usually called `{component-name}.html.twig`
