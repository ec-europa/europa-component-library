...
Ex: https://cdn1.fpfis.tech.ec.europa.eu/ecl/v3.9.1/eu/styles/optional/ecl-ec-default.css
...
Ex: `<link
  rel="stylesheet"
  href="https://cdn1.fpfis.tech.ec.europa.eu/ecl/v3.9.1/eu/styles/optional/ecl-ec-default.css"
...
In order to ease the access to the package containing those resources, the `preset-eu` package is also deployed in the github release page and can be downloaded from there.
...
There are also other optional css files distributed that can be used, see below for firther information about them.
