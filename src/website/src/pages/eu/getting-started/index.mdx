...
All the elements containing a `data-ecl-tooltip` or a `data-ecl-tooltip-inverted` inverted will have their tooltip associated, it will show the content of the `title` attribute.
