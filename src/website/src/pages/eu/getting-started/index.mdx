...
- presets (EC and EU) `@ecl/preset-eu`
...
- resources packages `@ecl/resources-eu-{name}`
...
Ex: `<link
  rel="stylesheet"
  href="https://cdn1.fpfis.tech.ec.europa.eu/ecl/v3.9.1/eu/styles/optional/ecl-eu-default.css"
...
There are also other optional css files distributed that can be used, see below for further information.
