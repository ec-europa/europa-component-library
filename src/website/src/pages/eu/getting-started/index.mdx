...
<ul>
  ...
  <li>
    <a
      className="ecl-link"
      href={`https://cdn1.fpfis.tech.ec.europa.eu/ecl/v${ECL_VERSION}/eu/scripts/ecl-esm-eu.js`}
    >
      {`https://cdn1.fpfis.tech.ec.europa.eu/ecl/v${ECL_VERSION}/eu/scripts/ecl-esm-eu.js`}
    </a>
  </li>
</ul>
