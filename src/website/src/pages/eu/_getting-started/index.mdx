...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://cdn1.fpfis.tech.ec.europa.eu/ecl/[ECL_VERSION]/eu-preset-website/styles/ecl-eu-preset-website.css"
      integrity="[sri hash of ecl-eu-preset-website.css]"
      crossorigin="anonymous"
      media="screen"
    />
    <link
      rel="stylesheet"
      href="https://cdn1.fpfis.tech.ec.europa.eu/ecl/[ECL_VERSION]/eu-preset-website/styles/ecl-eu-preset-website-print.css"
      integrity="[sri hash of ecl-eu-preset-website-print.css]"
      crossorigin="anonymous"
      media="print"
    />
  </head>
  <body>
    ...
    <script
      src="https://cdn1.fpfis.tech.ec.europa.eu/ecl/[ECL_VERSION]/eu-preset-website/scripts/ecl-eu-preset-website.js"
      integrity="[sri hash of ecl-eu-preset-website.js]"
      crossorigin="anonymous"
    ></script>
    <script>
      ECL.autoInit();
...
<ul>
  ...
  <li>
    ...
    <ul>
      <li>
        for ecl-eu-preset-website.css:{' '}
        <code>{process.env.ECL_EU_PRESET_WEBSITE_CSS}</code>
      </li>
      <li>
        for ecl-eu-preset-website-print.css:{' '}
        <code>{process.env.ECL_EU_PRESET_WEBSITE_PRINT_CSS}</code>
      </li>
      <li>
        for ecl-eu-preset-website.js:{' '}
        <code>{process.env.ECL_EU_PRESET_WEBSITE_JS}</code>
      </li>
    </ul>
  </li>
</ul>
