...
| viewport            | Extra small (≥ 0px) | Small (≥ 480px) | Medium (≥ 768px) | Large (≥ 996px) | Extra large (≥ 1140px) | Extra extra large (≥ 1368px) |
| ------------------- | ------------------- | --------------- | ---------------- | --------------- | ---------------------- | ---------------------------- |
| container max width | 100%                | 768px           | 996px            | 1140px          | 1368px                 | 1368px                       |
| class prefix        | `.ecl-col-`         | `.ecl-col-s-`   | `.ecl-col-m-`    | `.ecl-col-l-`   | `.ecl-col-xl-`         | `.ecl-col-xxl-`              |
