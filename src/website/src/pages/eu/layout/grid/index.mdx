...
import Example234612 from '@ecl/eu-react-layout-grid/examples/234612';
import Example642 from '@ecl/eu-react-layout-grid/examples/642';
import Example282 from '@ecl/eu-react-layout-grid/examples/282';
import Example336 from '@ecl/eu-react-layout-grid/examples/336';
import Offset from '@ecl/eu-react-layout-grid/examples/Offset';
...
When using the ECL grid, there is the ability to offset columns. You can offset columns from left to right by invoking the `.ecl-offset-*` classes (where \* = the number of columns). These classes simply increases the left margin by \* number of columns.
