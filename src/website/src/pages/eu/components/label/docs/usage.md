...
- don't use more than 2 labels at the same time (in one list). This creates ambiguity and visual noise. If the number of states is large, consider a filter or structured table
...
- do not use when you need to categorise or classify content by topic, e.g. theme, type, etc. - instead use [Tags](https://ec.europa.eu/component-library/eu/components/tag/code/), designed for category metadata rather than status indication
