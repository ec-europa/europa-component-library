...
- do not use the in-page navigation to link to content beyond the current page. It is an on-page way-finding, not a cross-site navigation tool. Instead, opt for the [Menu](https://ec.europa.eu/component-library/eu/components/navigation/menu/code/), [Mega menu](https://ec.europa.eu/component-library/eu/components/navigation/mega-menu/code/), or [Navigation list](https://ec.europa.eu/component-library/eu/components/navigation/navigation-list/code/) components
