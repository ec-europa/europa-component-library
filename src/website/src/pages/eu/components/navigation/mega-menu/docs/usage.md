...
- use when the volume or depth of navigation would overwhelm or exceed what the standard [Menu](https://ec.europa.eu/component-library/eu/components/navigation/menu/code/) can reasonably support
...
- do not use when the site has only one or two levels of navigation. Instead consider using the standard [Menu](https://ec.europa.eu/component-library/eu/components/navigation/menu/code/), better suited to shallower structures and with less complexity for editors and users
