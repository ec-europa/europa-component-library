...
- do not use as a substitute for site navigation or section-level way-finding; instead, use the [Menu](https://ec.europa.eu/component-library/eu/components/navigation/menu/code/) or [Navigation List](https://ec.europa.eu/component-library/eu/components/navigation/navigation-list/code/)
