...
- do not use if users may need exact figures, to compare multiple attributes, or to explore data in detail. Instead, use a [Table](https://ec.europa.eu/component-library/eu/components/table/code/) component
