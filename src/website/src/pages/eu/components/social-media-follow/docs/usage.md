...
- do not use as a substitute for the [Social media share](https://ec.europa.eu/component-library/eu/components/social-media-share/usage/) component, which allows users to share a specific page
