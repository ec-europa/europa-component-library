import demoDefault from '@ecl/specs-component-social-media-follow/demo/data--eu';
import demoColor from '@ecl/specs-component-social-media-follow/demo/data--eu-color';
