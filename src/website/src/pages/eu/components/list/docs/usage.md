...
- do not use when items share overarching categories that themselves require description. Instead consider using a [Table](https://ec.europa.eu/component-library/eu/components/table/code/) or a structured content layout that will communicate those relationships more clearly
- do not use for lists of items that may benefit from supplementary imagery. Instead, consider using the [List with Illustrations](https://ec.europa.eu/component-library/eu/components/list-illustration/code/) component
