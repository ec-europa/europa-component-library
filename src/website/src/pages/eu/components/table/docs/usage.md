...
- do not use a table when the content items have no meaningful relationship to one another; instead, use a [List](https://ec.europa.eu/component-library/eu/components/list/code/) for simple, unrelated content
