...
<Playground system="eu" selectedKind="Button" selectedStory="primary">
  <Button {...demoContentPrimary} />
</Playground>

## Secondary

<Playground system="eu" selectedKind="Button" selectedStory="secondary">
  <Button {...demoContentSecondary} />
</Playground>

## Call to action with icon

<Playground system="eu" selectedKind="Button" selectedStory="call to action">
  <Button {...demoContentCall} />
</Playground>

## Ghost

<Playground system="eu" selectedKind="Button" selectedStory="ghost">
  <Button {...demoContentGhost} />
</Playground>

## Search

<Playground system="eu" selectedKind="Button" selectedStory="search">
