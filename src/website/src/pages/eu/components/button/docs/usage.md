...
- always include the label (e.g. “Secondary button”) in the corresponding span class (e.g. “<span class="ecl-button__label" data-ecl-label="true">Secondary button</span>”) and ensure it is adapted to the selected icon, in order to provide the right context to screen user
