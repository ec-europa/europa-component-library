...
- Do not use for navigation or download actions – use [Links](https://ec.europa.eu/component-library/eu/components/navigation/link/code/) or [Files](https://ec.europa.eu/component-library/eu/components/file/code/) components instead
