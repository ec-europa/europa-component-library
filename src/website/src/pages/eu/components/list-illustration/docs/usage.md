...
- do not use when the primary purpose of the items is navigation or user action. Instead use the [Card](https://ec.europa.eu/component-library/eu/components/card/code/) or [Content item](https://ec.europa.eu/component-library/eu/components/content-item/code/) components
