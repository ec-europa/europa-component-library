...
- if using with an Event (dedicated content item variant making use of the [Date block](https://ec.europa.eu/component-library/eu/components/date-block/code/) component) split over multiple days, make sure to include the date range
...
- do not use when navigation structure or hierarchy (i.e. not content preview) is the primary need, use [Navigation list](https://ec.europa.eu/component-library/eu/components/navigation/navigation-list/code/) instead
- do not use when asingle, high-priority content item requires emphasis or a differentiated presentation, use [Featured item](https://ec.europa.eu/component-library/eu/components/media/featured-item/code/) or [Banner](https://ec.europa.eu/component-library/eu/components/banner/code/) components instead
