...
- do not use when the expected input is long or open-ended - opt instead for a [Text area](https://ec.europa.eu/component-library/eu/components/forms/text-area/code/) input, to signal that a more comprehensive answer is welcome
- do not use when the answer must come from a known set of options, to be validated. Use instead a structured selection component such as [Radio](https://ec.europa.eu/component-library/eu/components/forms/radio/code/) for small mutually exclusive sets, [Checkbox](https://ec.europa.eu/component-library/eu/components/forms/checkbox/code/) for multi-select, [Select](https://ec.europa.eu/component-library/eu/components/forms/select/code/) for longer lists
