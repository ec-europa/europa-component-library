...
- **do not use** when the user must respond **with specific options which are known to the organisation** - use form types such as Checkboxes, <Link to="/eu/components/forms/radio/usage/">Radio Buttons</Link> or Selects instead
