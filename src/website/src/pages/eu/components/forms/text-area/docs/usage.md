...
- do not use when the anticipated input is short and predictable (e.g. name, email address, or a number) - use a [Text field](https://ec.europa.eu/component-library/eu/components/forms/text-field/code/) instead, as it sets the right expectation about response length and is easier to scan in a form layout
- do not use when the answer must come from a known set of options, that is validated. Use instead a structured selection component such as [Radio](https://ec.europa.eu/component-library/eu/components/forms/radio/code/) for small mutually exclusive sets - [Checkbox](https://ec.europa.eu/component-library/eu/components/forms/checkbox/code/) for multi-select, or [Select](https://ec.europa.eu/component-library/eu/components/forms/select/code/) for longer lists
