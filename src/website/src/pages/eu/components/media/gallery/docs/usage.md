...
- do not use for non-linear browsing where inline media placement within the page content is more suitable. Use the [Media container](https://ec.europa.eu/component-library/eu/components/media/media-container/code/)
