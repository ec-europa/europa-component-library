...
order: 1
---
The Featured Item component pairs textual content with a media asset to create a visually prominent, self-contained unit. The [Media Container](https://ec.europa.eu/component-library/eu/components/media/media-container/code/) provides the media element and extends it with descriptive text and an optional call to action.
...
- do not use when you simply need to display a media asset, i.e. without accompanying text. Consider instead the [Media Container](https://ec.europa.eu/component-library/eu/components/media/media-container/code/)
