...
Note: for embedded videos, the ratio is calculated based on the width and height provided with the video. It ensures a consisten display on all screen sizes.
