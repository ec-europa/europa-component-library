...
- do not reach for icons simply to add visual interest or break up content. Their value is functional, not decorative. Instead, use [Labels](https://ec.europa.eu/component-library/eu/components/label/code/) or structured layout patterns where visual hierarchy is the underlying need
