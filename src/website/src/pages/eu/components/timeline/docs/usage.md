...
- do not use the Timeline when presenting procedural steps or user actions - the Timeline is a display component for past or scheduled events, not a guide for sequential tasks. For step-by-step instructions or multi-stage processes, consider an [Ordered list](https://ec.europa.eu/component-library/eu/components/list/code/)
- do not use the Timeline for items that share the same start time. Consider instead an [Unordered list](https://ec.europa.eu/component-library/eu/components/list/code/) or the [Facts and Figures](https://ec.europa.eu/component-library/eu/components/fact-figures/code/) component
