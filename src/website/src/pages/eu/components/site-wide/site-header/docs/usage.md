...
order: 1
---
The Site header offers easily recognisable elements (such as the logo) and essential functionality (such as Language switcher or [Search form](https://ecl-preview-2241--europa-component-library.netlify.app/eu/components/forms/search-form/code/)). The header is always placed at the top of the page.
...
| 4    | Search form        | mandatory     | optional    | Enables the user to search and retrieve related information using keywords                                                                                                                        |
| 5    | Site name          | mandatory     | mandatory   | Name of the website                                                                                                                                                                               |
| 6    | Menu               | optional      | optional    | Main navigation of the website                                                                                                                                                                    |
