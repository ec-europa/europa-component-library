...
- do not use when the information could be surfaced without requiring user action or blocking the page - instead, consider using a [Notification](../../notification/code/) or [Tooltip](../../tooltip/code) which may be more appropriate, less disruptive
