...
- do not use when the information could be surfaced without requiring user action or blocking the page - instead, consider using a [Notification](https://ec.europa.eu/component-library/eu/components/notification/code/) or [Tooltip](http://citnet.tech.ec.europa.eu/) which may be more appropriate, less disruptive
