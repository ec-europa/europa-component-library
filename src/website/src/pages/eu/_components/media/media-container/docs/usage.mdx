...
- Do not use the media container if there are above 5 consecutive items (this would make navigation more difficult) - use an <Link to="/eu/components/list/usage/">unordered list</Link> or a <Link to="/eu/components/media/gallery/usage/">media gallery</Link>
