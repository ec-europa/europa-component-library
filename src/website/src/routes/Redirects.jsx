...
export default () => (
  <Switch>
    ...
    <Redirect from="/r/eu-file-upload" to="/eu/components/forms/file-upload/" />
    <Redirect from="/r/eu-radio" to="/eu/components/forms/radio/" />
    <Redirect from="/r/eu-search-form" to="/eu/components/forms/search-form/" />
    ...
    <Redirect from="/r/eu-disable-scroll" to="/eu/utilities/disable-scroll/" />
