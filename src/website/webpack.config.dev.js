...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      'process.env.ECL_EC_CSS': JSON.stringify('n/a'),
      'process.env.ECL_EC_PRINT_CSS': JSON.stringify('n/a'),
      'process.env.ECL_EC_DEFAULT_CSS': JSON.stringify('n/a'),
      'process.env.ECL_EC_JS': JSON.stringify('n/a'),
      'process.env.ECL_EU_CSS': JSON.stringify('n/a'),
      'process.env.ECL_EU_PRINT_CSS': JSON.stringify('n/a'),
