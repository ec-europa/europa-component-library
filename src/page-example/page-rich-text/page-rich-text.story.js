...
import dataRichText from './demo/data';
import richText from './page-rich-text.html.twig';
...
Default.render = async () => {
  const renderedRichText = await richText(prepareData(dataRichText));
