...
module.exports = {
  scripts: [
    {
      entry: path.resolve(__dirname, 'src/eu-preset-legacy.js'),
      dest: path.resolve(outputFolder, 'scripts/ecl-eu-preset-legacy.js'),
      options: {
        banner,
        moduleName: 'ECL',
  ...
  styles: [
    {
      entry: path.resolve(__dirname, 'src/eu-preset-legacy.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-eu-preset-legacy.css'),
      options: {
        banner,
        includePaths,
    ...
    {
      entry: path.resolve(__dirname, 'src/eu-preset-legacy-print.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-eu-preset-legacy-print.css'),
      options: {
        banner,
        includePaths,
        sourceMap: isProd ? 'file' : true,
