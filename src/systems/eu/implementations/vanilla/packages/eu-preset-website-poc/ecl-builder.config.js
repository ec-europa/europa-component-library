...
module.exports = {
  scripts: [
    {
      entry: path.resolve(__dirname, 'src/eu-preset-website-poc.js'),
      dest: path.resolve(outputFolder, 'scripts/ecl-eu-preset-website-poc.js'),
      options: {
        banner,
        moduleName: 'ECL',
  ...
  styles: [
    {
      entry: path.resolve(__dirname, 'src/eu-preset-website-poc.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-eu-preset-website-poc.css'),
      options: {
        banner,
        includePaths,
    ...
    {
      entry: path.resolve(__dirname, 'src/eu-preset-website-poc-print.scss'),
      dest: path.resolve(
        outputFolder,
        'styles/ecl-eu-preset-website-poc-print.css'
      ),
      options: {
        banner,
        includePaths,
