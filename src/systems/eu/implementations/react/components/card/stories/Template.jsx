...
import demoContentCardTaxonomy from '@ecl/eu-specs-card/demo/data--card-taxonomy';
import demoContentTile from '@ecl/eu-specs-card/demo/data--tile';
import demoContentTileTaxonomy from '@ecl/eu-specs-card/demo/data--tile-taxonomy';
