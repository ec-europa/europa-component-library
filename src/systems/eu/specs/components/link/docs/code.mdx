...
>
  <p className="ecl-type--paragraph">The European Commission is the executive of <Link {...demoContentDefault} /> and promotes its general interest.</p>
</Playground>
...
<Playground
  ...
  selectedStory="default"
>
  <p className="ecl-type--paragraph">The European Commission is the executive of <Link {...demoContentIcon} /> and promotes its general interest.</p>
</Playground>
