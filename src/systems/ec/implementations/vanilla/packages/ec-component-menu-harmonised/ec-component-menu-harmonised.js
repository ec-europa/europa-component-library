...
export class MenuHarmonised {
   ...
   *
   * @return {MenuHarmonised} An instance of MenuHarmonised.
   */
  static autoInit(root, { MENU_HARMONISED: defaultOptions = {} } = {}) {
    const menuHarmonised = new MenuHarmonised(root, defaultOptions);
    menuHarmonised.init();
    // eslint-disable-next-line no-param-reassign
    root.ECLMenuHarmonised = menuHarmonised;
    return menuHarmonised;
  }
  ...
  constructor(
    element,
    {
      ...
      menuMegaSelector = '[data-ecl-menu-harmonised-mega]',
