...
module.exports = {
  scripts: [
    {
      entry: path.resolve(__dirname, 'src/ec-preset-legacy-website.js'),
      dest: path.resolve(
        outputFolder,
        'scripts/ecl-ec-preset-legacy-website.js'
      ),
      options: {
        banner,
        moduleName: 'ECL',
  ...
  styles: [
    {
      entry: path.resolve(__dirname, 'src/ec-preset-legacy-website.scss'),
      dest: path.resolve(
        outputFolder,
        'styles/ecl-ec-preset-legacy-website.css'
      ),
      options: {
        banner,
        includePaths,
    ...
    {
      entry: path.resolve(__dirname, 'src/ec-preset-legacy-website-print.scss'),
      dest: path.resolve(
        outputFolder,
        'styles/ecl-ec-preset-legacy-website-print.css'
      ),
      options: {
        banner,
        includePaths,
