...
storiesOf('Utilities|Editor', module)
    ...
    return (
      <div className="ecl-editor">
        ...
        <p>
          ...
          Maecenas ac neque in nibh ornare consequat. Proin commodo sed dolor
          sit amet pulvinar. Vestibulum ante ipsum primis in faucibus orci
          luctus.
        </p>
