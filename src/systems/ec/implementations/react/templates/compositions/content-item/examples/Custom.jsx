...
import demoContentCustom from '@ecl/ec-specs-content-item/demo/data--custom';
...
export default () => (
  <ContentItem {...demoContentCustom}>
    ...
    <a
      href="/example"
      className="ecl-u-mt-s ecl-u-d-inline-block ecl-u-type-bold ecl-u-type-prolonged-m ecl-link ecl-link--standalone"
    >
      Nullam nisi eros, convallis sit amet tellus vel, placerat elementum nisi.
      Vestibulum dignissim erat pretium dignissim finibus.
    </a>
