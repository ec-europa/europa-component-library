      ...
      <div className="ecl-row">
        ...
        <div className="ecl-col-12 ecl-col-lg-9">
          ...
          <DescriptionList variant="horizontal" className="ecl-u-mb-l">
            ...
            <DescriptionDefinition>Vytenis Andriukaitis</DescriptionDefinition>
            <DescriptionTerm>Title</DescriptionTerm>
            <DescriptionDefinition>
              Commissioner (2014 - 2019)
            </DescriptionDefinition>
            <DescriptionTerm>Organization</DescriptionTerm>
            <DescriptionDefinition>Health & Food Safety</DescriptionDefinition>
          </DescriptionList>
        </div>
      </div>
        ...
        <div className="ecl-col-12 ecl-col-lg-9">
          <main>
            ...
            <UnorderedList className="ecl-u-mt-none ecl-u-mb-xl ecl-u-mb-lg-l">
              <UnorderedListItem>
                modernising and simplifying EU food safety policy while keeping
                the current high level of safety and ensuring existing policies
                have maximum effect.
              </UnorderedListItem>
              <UnorderedListItem>
