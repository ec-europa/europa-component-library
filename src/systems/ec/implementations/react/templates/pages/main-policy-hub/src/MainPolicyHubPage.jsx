        ...
        <div className="ecl-row">
          <div className="ecl-col-12 ecl-col-md-6">
            ...
            <p className="ecl-u-type-paragraph ecl-u-type-color-grey ecl-u-type-mt-l ecl-u-mb-none">
              ...
              improve air quality by controlling emissions of harmful substances
              into the atmosphere, improving fuel quality, and by integrating
              environmental protection requirements into the transport and
              energy sectors.
            </p>
          </div>
      ...
      <div className="ecl-u-mt-xl ecl-u-mt-lg-3xl ecl-u-pv-l ecl-u-bg-blue-5">
        <div className="ecl-container ecl-u-type-m">
          ...
          <p className="ecl-u-type-paragraph ecl-u-type-color-grey ecl-u-mt-m ecl-u-mb-none">
            ...
            towards improving air quality, the European Commission adopted in
            2013 a Clean Air Policy Package, including a Clean Air Programme for
            Europe setting objectives for 2020 and 2030, and accompanying
          ...
          <div className="ecl-row ecl-u-mt-m ecl-u-mt-lg-l ecl-u-border-top ecl-u-border-color-grey-25">
            ...
            <div className="ecl-col-12 ecl-col-md-6">
              ...
              <p className="ecl-u-type-paragraph ecl-u-type-color-grey ecl-u-mt-m ecl-u-mb-none">
                ...
                emission abatement measures will continue to be implemented.
              </p>
          ...
          <div className="ecl-row">
            <div className="ecl-col-12 ecl-col-md-6">
              ...
              <DescriptionList variant="horizontal" className="ecl-u-mt-l">
                ...
                <DescriptionDefinition>Roberto Fallieri</DescriptionDefinition>
