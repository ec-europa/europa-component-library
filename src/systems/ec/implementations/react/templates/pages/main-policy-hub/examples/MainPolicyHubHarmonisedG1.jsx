...
class MainPolicyHubHarmonisedG1 extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        />
        <MainPolicyHubPage template="harmonised-g1" />
...
MainPolicyHubHarmonisedG1.propTypes = {
...
MainPolicyHubHarmonisedG1.defaultProps = {
...
export default MainPolicyHubHarmonisedG1;
