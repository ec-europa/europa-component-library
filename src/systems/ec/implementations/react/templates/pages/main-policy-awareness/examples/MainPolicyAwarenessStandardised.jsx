...
class MainPolicyAwarenessStandardised extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        <MainPolicyAwarenessPage template="standardised" />
...
MainPolicyAwarenessStandardised.propTypes = {
...
MainPolicyAwarenessStandardised.defaultProps = {
...
export default MainPolicyAwarenessStandardised;
