...
class MainPolicyAwarenessCore extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        <MainPolicyAwarenessPage template="core" />
