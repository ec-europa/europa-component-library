...
class EventSpeakerCore extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <EventSpeakerPage template="core" />
