...
import getData from '@ecl/ec-specs-event-speaker-page/demo/data';

import EventSpeakerPage from '../src/EventSpeakerPage';

class EventSpeakerHarmonisedG1 extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
...
EventSpeakerHarmonisedG1.propTypes = {
...
EventSpeakerHarmonisedG1.defaultProps = {
...
export default EventSpeakerHarmonisedG1;
