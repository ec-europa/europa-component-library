...
class FundingProgrammeCore extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <FundingProgrammePage template="core" />
