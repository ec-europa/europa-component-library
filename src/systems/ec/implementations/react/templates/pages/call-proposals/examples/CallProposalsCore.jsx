...
class CallProposalsCore extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <CallProposalsPage template="core" />
