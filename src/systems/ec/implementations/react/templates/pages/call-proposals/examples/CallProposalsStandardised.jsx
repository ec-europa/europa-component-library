...
class CallProposalsStandardised extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        <CallProposalsPage template="standardised" />
...
CallProposalsStandardised.propTypes = {
...
CallProposalsStandardised.defaultProps = {
...
export default CallProposalsStandardised;
