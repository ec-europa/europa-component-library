...
class CallProposalsHarmonisedG2 extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        />
        <CallProposalsPage template="harmonised-g2" />
        <FooterHarmonised
          {...dataCopy.footer}
...
CallProposalsHarmonisedG2.propTypes = {
...
CallProposalsHarmonisedG2.defaultProps = {
...
export default CallProposalsHarmonisedG2;
