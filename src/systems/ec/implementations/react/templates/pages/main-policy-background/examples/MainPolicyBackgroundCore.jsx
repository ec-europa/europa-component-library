...
class MainPolicyBackgroundCore extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <MainPolicyBackgroundPage template="core" />
