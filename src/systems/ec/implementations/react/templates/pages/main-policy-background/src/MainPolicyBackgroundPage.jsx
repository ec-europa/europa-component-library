    ...
    <div className="ecl-container ecl-u-type-m">
      <main>
        <p className="ecl-u-type-paragraph ecl-u-type-color-black ecl-u-mt-none">
          ...
          also impacts on quality of life by causing or exacerbating asthma and
          respiratory problems. Air pollution causes lost working days, and high
          healthcare costs, with vulnerable groups such as children, ashtmatics
        ...
        <p className="ecl-u-type-paragraph ecl-u-type-color-black">
          ...
          early 1970s, the EU has been working to improve air quality by
          controlling emissions of harmful substances into the atmosphere,
        ...
        <p className="ecl-u-type-paragraph ecl-u-type-color-black">
          ...
          continues to cause serious and avoidable problems. As a next step
          towards improving air quality, the European Commission adpoted in 2013
          a Clear Air Policy Package, including a Clean Air Programme for Europe
        ...
        <p className="ecl-u-type-paragraph ecl-u-type-color-black">
          ...
          protocol was agreed in November 1999 and formed the basis for the
          original NEC Directive 2001/81/EC. The protocol was revised in 2012
          and the reduction commitments established for 2020 for the new
          Directive on National Emission Reductions (Directive 2016/2284/EU).
        ...
        <p className="ecl-u-type-paragraph ecl-u-type-color-black ecl-u-mb-none">
          ...
          such as Black Carbon and intercontinental transport of air pollution.
        </p>
