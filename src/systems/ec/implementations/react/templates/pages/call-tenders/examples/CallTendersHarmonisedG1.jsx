...
class CallTendersHarmonisedG1 extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        />
        <CallTendersPage template="harmonised-g1" />
...
CallTendersHarmonisedG1.propTypes = {
...
CallTendersHarmonisedG1.defaultProps = {
...
export default CallTendersHarmonisedG1;
