...
class ResearchAreaHubHarmonisedG2 extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        />
        <ResearchAreaHubPage template="harmonised-g2" />
...
ResearchAreaHubHarmonisedG2.propTypes = {
...
ResearchAreaHubHarmonisedG2.defaultProps = {
...
export default ResearchAreaHubHarmonisedG2;
