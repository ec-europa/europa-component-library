...
class ResearchAreaHubStandardised extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        <ResearchAreaHubPage template="standardised" />
...
ResearchAreaHubStandardised.propTypes = {
...
ResearchAreaHubStandardised.defaultProps = {
...
export default ResearchAreaHubStandardised;
