...
class CommemorativeCoinCore extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        <CommemorativeCoinPage template="core" />
