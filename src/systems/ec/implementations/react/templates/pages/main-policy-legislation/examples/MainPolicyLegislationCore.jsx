...
class MainPolicyLegislationCore extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <MainPolicyLegislationPage template="core" />
