          ...
          <main>
            ...
            <p className="ecl-u-type-paragraph ecl-u-type-color-grey ecl-u-mt-m ecl-u-mb-none">
              ...
              <Link
                ...
                icon={{ shape: 'ui--external', size: 'xs' }}
              />{' '}
              will contribute to the creation of new blue jobs, social wellbeing
              and a sustainable growth in the marine and maritime sectors
              through the implementation of its Strategic Research and
              Innovation Agenda,{' '}
              <Link
                href="/example"
                variant="external"
            ...
            <UnorderedList className="ecl-u-mt-m ecl-u-mb-none ecl-u-type-color-black">
              ...
              <UnorderedListItem>
                <Link variant="standalone" href="/example" label="Fact sheet" />
              </UnorderedListItem>
              <UnorderedListItem>
                <Link href="/example" label="Bucharest declaration" /> launching
                the Black Sea research and innovation agenda
              </UnorderedListItem>
            </UnorderedList>
