...
class ResearchAreaSpokeHarmonisedG2 extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        />
        <ResearchAreaSpokePage template="harmonised-g2" />
...
ResearchAreaSpokeHarmonisedG2.propTypes = {
...
ResearchAreaSpokeHarmonisedG2.defaultProps = {
...
export default ResearchAreaSpokeHarmonisedG2;
