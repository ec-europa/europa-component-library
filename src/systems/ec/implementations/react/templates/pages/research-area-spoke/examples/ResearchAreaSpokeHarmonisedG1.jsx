...
class ResearchAreaSpokeHarmonisedG1 extends React.Component {
  constructor(props) {
    super(props);
    this.autoinit = null;
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        />
        <ResearchAreaSpokePage template="harmonised-g1" />
...
ResearchAreaSpokeHarmonisedG1.propTypes = {
...
ResearchAreaSpokeHarmonisedG1.defaultProps = {
...
export default ResearchAreaSpokeHarmonisedG1;
