...
class ResearchAreaSpokeCore extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <ResearchAreaSpokePage template="core" />
