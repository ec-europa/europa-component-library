...
<Playground playgroundLink="/storybook/ec/index.html?selectedKind=Breadcrumb&selectedStory=simple&stories=0">
...
<Playground playgroundLink="/storybook/ec/index.html?selectedKind=Breadcrumb&selectedStory=long&stories=0">
