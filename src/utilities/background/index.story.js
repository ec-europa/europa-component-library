  ...
  if (system === 'ec') {
    ...
    argTypes.background_color_mode = {
      ...
      options: [
        ...
        'surface-color-mode-lowest',
        'surface-color-mode-low',
        'surface-color-mode-high',
        'surface-low-0',
        'surface-low-1',
        'surface-low-2',
        'surface-medium-0',
        'surface-medium-1',
        'surface-0',
        'surface-0-add-to-calendar',
        'surface-0-text-media',
        'surface-variant-1',
        'surface-variant-2',
      ...
      mapping: {
        ...
        'surface-color-mode-lowest': 'surface-color-mode-lowest',
        'surface-color-mode-low': 'surface-color-mode-low',
        'surface-color-mode-high': 'surface-color-mode-high',
        ...
        'surface-0': 'surface-0',
        'surface-0-add-to-calendar': 'surface-0-add-to-calendar',
        'surface-0-text-media': 'surface-0-text-media',
