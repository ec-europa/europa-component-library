  ...
  if (system === 'ec') {
    ...
    argTypes.background_color_mode = {
      ...
      options: [
        ...
        'surface-primary-low',
        'surface-primary-medium',
        'surface-primary',
        'surface-primary-high',
        'surface-primary-highest',
        'surface-secondary-low',
        'surface-secondary',
        'surface-secondary-high',
        'surface-secondary-highest',
        'surface-neutral-lowest',
        'surface-neutral-low',
        'surface-neutral-medium',
        'surface-grey-low',
        'surface-grey-low-1',
        'surface-status-error-lowest',
        'surface-status-error',
        'surface-status-warning-lowest',
        'surface-status-warning',
        'surface-status-success-lowest',
        'surface-status-success',
        'surface-status-info-lowest',
        'surface-status-info',
      ...
      mapping: {
        ...
        'surface-primary-lowest': 'surface-primary-lowest',
        'surface-primary-low': 'surface-primary-low',
        'surface-primary-medium': 'surface-primary-medium',
        'surface-primary': 'surface-primary',
        'surface-primary-high': 'surface-primary-high',
        'surface-primary-highest': 'surface-primary-highest',
        'surface-secondary-low': 'surface-secondary-low',
        'surface-secondary': 'surface-secondary',
        'surface-secondary-high': 'surface-secondary-high',
        'surface-secondary-highest': 'surface-secondary-highest',
        'surface-neutral-lowest': 'surface-neutral-lowest',
        'surface-neutral-low': 'surface-neutral-low',
        'surface-neutral-medium': 'surface-neutral-medium',
        'surface-grey-low': 'surface-grey-low',
        'surface-grey-low-1': 'surface-grey-low-1',
        'surface-status-error-lowest': 'surface-status-error-lowest',
        'surface-status-error': 'surface-status-error',
        'surface-status-warning-lowest': 'surface-status-warning-lowest',
        'surface-status-warning': 'surface-status-warning',
        'surface-status-success-lowest': 'surface-status-success-lowest',
        'surface-status-success': 'surface-status-success',
        'surface-status-info-lowest': 'surface-status-info-lowest',
        'surface-status-info': 'surface-status-info',
