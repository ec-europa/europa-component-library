module.exports = {
  ...
  items: [
    ...
    {
      title: 'List with illustration item 5',
      image: {
        alt: 'alt text for image',
        src: 'https://inno-ecl.s3.amazonaws.com/media/examples/example-image.jpg',
      },
    ...
    {
      title: 'List with illustration item 6',
      image: {
        alt: 'alt text for image',
        src: 'https://inno-ecl.s3.amazonaws.com/media/examples/example-image.jpg',
      },
    ...
    {
      title: 'List with illustration item 7',
      image: {
        alt: 'alt text for image',
        src: 'https://inno-ecl.s3.amazonaws.com/media/examples/example-image.jpg',
      },
    ...
    {
      title: 'List with illustration item 8',
      image: {
        alt: 'alt text for image',
        src: 'https://inno-ecl.s3.amazonaws.com/media/examples/example-image.jpg',
      },
    ...
    {
      title: 'List with illustration item 9',
      image: {
        alt: 'alt text for image',
        src: 'https://inno-ecl.s3.amazonaws.com/media/examples/example-image.jpg',
      },
