...
- **"link"** (object) (default: {}):
  - "type" (string) (default: '') Link type; can be '', 'standalone', 'primary', 'primary-highlight', 'primary-neutral', 'secondary', 'secondary-neutral', 'secondary-inverted', 'tertiary', 'tertiary-neutral', 'tertiary-inverted'
  ...
  - "no_icon_wrapping" (boolean) (default: false) Prevents icon from wrapping in a new line alone
