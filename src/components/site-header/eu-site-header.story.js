...
import enDataMenuLong from '@ecl/menu/demo/data--eu-long';
import enDataMegaMenu from '@ecl/mega-menu/demo/data';
import dataFullEU from './demo/data--eu';
...
const prepareData = (data, args) => {
  ...
  clone.logo.src_desktop = enLogoDesktopEU;
  clone.logo.src_mobile = enLogoMobileEU;
