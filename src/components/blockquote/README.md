...
- **"citation"** (string) (default: '') The quote text
- **"author"** (string) (default: '') The author of the quote
- **"lang"** (string) (default: 'en') Language code for the citation text (ISO 639-1)
